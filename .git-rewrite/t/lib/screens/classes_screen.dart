  ...
  Widget _buildJoinedClassCard(ClassRow cls) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        // Homework
        if (hw.isNotEmpty) _section('📝 ${tr('homework')}', Column(children: [
          Row(children: [
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(backgroundColor: context.primary, foregroundColor: Colors.white, padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 8), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
              child: Text(tr('study'), style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
            ),
          ]),
          if (hwAllDone) ...[
            const SizedBox(height: 6),
