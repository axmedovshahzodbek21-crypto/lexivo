...
class _StarredWordsScreenState extends State<StarredWordsScreen> {
  ...
  Future<void> _removeWord(int index) async {
    ...
    setState(() => _starredWords.removeAt(index));
  }
...
class _CollectionPickerOverlayState extends State<_CollectionPickerOverlay>
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (!_isBeginnerLevel) const SizedBox(height: 8),
                            _buildImportWordsTile(context),
                          ],
                        ),
                      ),
                    ),
  ...
  Widget _buildImportWordsTile(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const ImportedWordsScreen()),
      ),
      child: Container(
        margin: const EdgeInsets.only(bottom: 4),
        padding: const EdgeInsets.all(16),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Paste any text — AI extracts vocabulary',
