...
class ImportCollectionDetailScreen extends StatefulWidget {
  ...
  const ImportCollectionDetailScreen({super.key, required this.collectionName});
...
class _ImportCollectionDetailScreenState extends State<ImportCollectionDetailScreen> {
  ...
  Future<void> _load() async {
    final words = await StorageService.getImportedWordsByCollection(widget.collectionName);
  ...
  Future<void> _openImport() async {
    await Navigator.push(context, MaterialPageRoute(
      builder: (_) => ImportScreen(prefilledCollection: widget.collectionName),
    ));
    _load();
  }
  ...
  Future<void> _deleteCollection() async {
    ...
    if (confirm == true) {
      await StorageService.deleteImportedCollection(widget.collectionName);
  ...
  Future<void> _deleteWord(ImportedWord word) async {
    ...
    if (confirm == true) {
      await StorageService.deleteImportedWord(word.word, widget.collectionName);
      _load();
    }
  }
