                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text('08:00', style: TextStyle(color: context.textMuted, fontSize: 13, fontWeight: FontWeight.w500)),
                          ],
                        ),
                        const SizedBox(height: 12),
                        ...
                        Row(
                          children: [
                            ...
                            Text('21:00', style: TextStyle(color: context.textMuted, fontSize: 13, fontWeight: FontWeight.w500)),
                          ],
                        ),
                        const SizedBox(height: 12),
                        const Divider(),
